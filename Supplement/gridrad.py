...
def plot_image(data):
	...
	for i in range(0,nfin):
		img[(ifin[0])[i],(ifin[1])[i],:] = (r[min(long(refl_max[(ifin[0])[i],(ifin[1])[i]]/5),14)]/255.0, \
														g[min(long(refl_max[(ifin[0])[i],(ifin[1])[i]]/5),14)]/255.0, \
														b[min(long(refl_max[(ifin[0])[i],(ifin[1])[i]]/5),14)]/255.0)
