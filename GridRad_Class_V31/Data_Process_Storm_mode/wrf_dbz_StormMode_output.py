...
The Storm Mode classification is now based on the updated Convective/Stratiform Masking algorithm for the Lambert-conformal-gridded WRF CONUS data.
...
def main_function(file_date_time):
    ...
    nc_wrf_dbz['Storm_Mode_mod'].description = 'Storm Modes - moderate thresholds (1:DCC; 2:OCC; 3:WCC; 4:DWCC; 5:BSR)'
    
    nc_wrf_dbz['Storm_Mode_str'][:] = Storm_Mode_s
    nc_wrf_dbz['Storm_Mode_str'].description = 'Storm Modes - strong thresholds (1:DCC; 2:OCC; 3:WCC; 4:DWCC; 5:BSR)'
